...
let contry = document.getElementById('contry') as HTMLInputElement
let serceh = document.getElementById('serceh') as HTMLInputElement
let mybtn = document.getElementById('mybtn') as HTMLButtonElement
