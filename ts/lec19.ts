// let mybtnn = document.getElementById('mybtnn') as HTMLButtonElement
// let mysection = document.getElementById('mysection') as HTMLDivElement
// class www {
//     str: string
//     tt: boolean
//     constructor(str: string, tt: boolean) {
//         this.str = str
//         this.tt = tt
//     }

// }
// let mytex: www[] = JSON.parse(localStorage.getItem('mynotes') ?? "[]")
// let myindex: number[] = JSON.parse(localStorage.getItem('myindex') ?? "[]")



// const issame = (r1: string, r2: string) => {
//     return r1 === r2
// }
...
//         mytextarea.disabled = false;
//         newfimg.classList.add('none')
//         let x: string = mytextarea.value
//         let index = mytex.findIndex((b: www) => issame(b.str, x));
//         console.log(index);
